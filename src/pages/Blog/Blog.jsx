      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 my-10 p-8">
        <div className="text-2xl text-justify ">
          ...
          <p>
            ...
            A controlled component is bound to a value, and its changes will be
        ...
        <div className="text-2xl text-justify">
          ...
          <p>
            ...
            NodeJS is a popular app development platform that is open-source and
            runs on servers. It is a cross-platform Javascript code used by
            developers these days to develop scalable apps. these days. The
            platform leverages a model that is asynchronous and event-driven. It
            is specifically designed to develop robust network applications. The
            platform is built on the V8 engine of Google, which makes it an
            efficient choice for the development of apps. <br />
            <strong>ExpressJS: </strong>
            ExpressJS is a web application framework used for NodeJS. It is the
            major difference between the two options. ExpressJS has several
            extraordinary features that make web app development easy and fast.
          </p>
        </div>
        <div className="text-2xl text-justify">
          <h1 className="mb-4">
